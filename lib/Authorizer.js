...
class Authorizer extends EventEmitter {
    ...
    constructor(options) {
        ...
        this.logger.verbose('options=', options, this._options);
    ...
    authorize(req, resultFunc) {
        ...
        if (!authHeader && (global.testing || req.baseUrl.startsWith('http://localhost') || req.baseUrl.startsWith('http://127.0.0.1'))) {
